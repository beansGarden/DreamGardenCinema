...
public class MypageController {
	...
	public String cancle(Model model, @SessionAttribute("loginUser") User loginuser) {
	...
	public String coupon(Model model, @SessionAttribute("loginUser") User loginuser) {
		int userNo = loginuser.getUserNo();
	...
	public String inquiry(Model model, @SessionAttribute("loginUser") User loginuser, Qna qna) {
	...
	public String changeNickName(@SessionAttribute("loginUser") User loginuser, @RequestParam String redirectUrl,
			String userNickname, RedirectAttributes ra) {
	...
	public String changeInfo(User updateUser, String[] memberAddress, String userEmail, String checkPw, String userPw,
			RedirectAttributes ra, @SessionAttribute("loginUser") User loginUser) {
	...
	public String secessionUser(@SessionAttribute("loginUser") User loginUser, RedirectAttributes ra,
